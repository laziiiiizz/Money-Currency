/**
 * Fetches currency list from Open Exchange Rates API and populates the "From" and "To" currency dropdowns.
 *
 * @param {string} apiKey - The API key for Open Exchange Rates.
 */
function populateCurrencyDropdowns(apiKey) {
